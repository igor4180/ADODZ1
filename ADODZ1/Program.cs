	...
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			try
			{
				...
				//for (int i = 26; i <= 50; i++)
				//{
				//	insertcommand.CommandText += "insert into fandv" + "(Id,Name,Type,Color,Calories)" + "values ("+i+ ",'name"+i+"','fruits','yellow',"+ random.Next(100,500)+");";	
				//}
				//Console.WriteLine("Было добавлено " + insertcommand.ExecuteNonQuery() + " строк");
				//sqlcommand command = new sqlcommand("select * from fruits and vegetables", connection);
